...
var _jqueryMinJs = require("../consumoApi/node_modules/jquery/dist/jquery.min.js");
var _jqueryMinJsDefault = parcelHelpers.interopDefault(_jqueryMinJs);
var _api = require("./api");
obtenerPokemon();
listarPokemones();
//quitar actualizacion con enter
(0, _jqueryMinJsDefault.default)("#inputPokemon").keypress(function(e) {
    if (e.keyCode == 13) {
        e.preventDefault();
        return false;
    }
...
//evento boton
(0, _jqueryMinJsDefault.default)("#buscar").on("click", ()=>{
    let nombre = (0, _jqueryMinJsDefault.default)("#inputPokemon").val();
    let pokemon = (0, _api.getPokemon)(nombre);
...
function llenarInformacion(name, sprites, stats, types) {
    ...
    let div = (0, _jqueryMinJsDefault.default)(".datos_pokemon");
    div.empty();
...
},{"./api":"eqUwj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../consumoApi/node_modules/jquery/dist/jquery.min.js":"kH14U"}],"eqUwj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
